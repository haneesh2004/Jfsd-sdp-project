...
<style>
    body {
        /*background-image: url('https://i.pinimg.com/736x/03/c9/5b/03c95ba8c214ea6f5b8e529aa848798d.jpg'); /* Replace with your image path */
...
<h4>${message }</h4>
    <form method="post" action="checkadminlogin">
        <div class="form-group">
            ...
            <input type="text" value="ram" id="auname" class="form-control" name="auname" required/>
        </div>

        <div class="form-group">
            <label for="apwd">Enter Password</label>
            <input type="password" value="ram" id="apwd" class="form-control" name="apwd" required/>
        </div>
